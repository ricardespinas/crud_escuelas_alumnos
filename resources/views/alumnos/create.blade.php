    ...
    <div class="container">
        ...
        <form action="{{ route('alumnos.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="fecha_nacimiento" id="fecha_nacimiento" class="form-control" value="{{ old('fecha_nacimiento') }}" required>
            </div>

            <div class="form-group">
                <label for="ciudad_natal">Ciudad Natal</label>
                <input type="text" name="ciudad_natal" id="ciudad_natal" class="form-control" value="{{ old('ciudad_natal') }}">
            </div>
            ...
            <div class="form-group">
                ...
                <select name="escuela_id" id="escuela_id" class="form-control" required>
                    ...
                    @foreach ($escuelas as $escuela)
                        <option value="{{ $escuela->id }}" {{ old('escuela_id') == $escuela->id ? 'selected' : '' }}>
                            {{ $escuela->nombre }}
                        </option>
                    @endforeach
                </select>
